...
import android.support.p003v7.recyclerview.C0270R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray a2 = context.obtainStyledAttributes(attrs, C0270R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a2.getString(C0270R.styleable.RecyclerView_layoutManager);
            if (a2.getInt(C0270R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
    ...
    private void createLayoutManager(android.content.Context r11, java.lang.String r12, android.util.AttributeSet r13, int r14, int r15) {
        ...
        L_0x0047:
            ...
            android.support.v7.widget.RecyclerView$LayoutManager r7 = (android.support.p003v7.widget.RecyclerView.LayoutManager) r7     // Catch:{ ClassNotFoundException -> 0x0088, InvocationTargetException -> 0x00aa, InstantiationException -> 0x00cc, IllegalAccessException -> 0x00ee, ClassCastException -> 0x0110 }
    ...
    public View focusSearch(View focused, int direction) {
        ...
        if (!canRunFocusFailure || !(direction == 2 || direction == 1)) {
            ...
            if (this.mLayout.canScrollVertically()) {
                int absDir = direction == 2 ? TransportMediator.KEYCODE_MEDIA_RECORD : 33;
