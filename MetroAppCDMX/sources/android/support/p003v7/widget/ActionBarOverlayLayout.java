...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = {C0267R.attr.actionBarSize, 16842841};
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0267R.C0269id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0267R.C0269id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0267R.C0269id.action_bar));
        }
    }
